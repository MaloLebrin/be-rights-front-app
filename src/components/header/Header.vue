<template>
  <header class="flex items-center max-h-36 w-full px-4 py-2 mx-auto dark:bg-blue-dark shadow-xl">
    <nav class="w-full">
      ...
      <div v-if="isMenuOpen" class="flex flex-col sm:hidden" id="mobile-menu">
