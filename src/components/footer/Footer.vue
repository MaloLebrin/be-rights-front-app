  ...
  <footer class="z-50 w-full shadow-3xl dark:bg-blue-dark_bold DarkModeAnimation">
    <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="flex-1 py-6 bg-gray-800 dark:bg-transparent">
        <p class="text-gray-200 uppercase lg:mt-4 md:mb-6">Menu</p>
        <ul class="mb-6 list-reset">
          <li class="inline-block mt-2 mr-2 md:block md:mr-0">
            <router-link :to="{ name: 'login' }" class="text-white no-underline hover:underline hover:text-red-light">Se
              connecter</router-link>
          </li>
          <li class="inline-block mt-2 mr-2 md:block md:mr-0">
            <router-link :to="{ name: 'register' }" class="text-white no-underline hover:underline hover:text-red-light">
              s'inscrire</router-link>
          </li>
          <li class="inline-block mt-2 mr-2 md:block md:mr-0">
            <router-link :to="{ name: 'home' }" class="text-white no-underline hover:underline hover:text-red-light">
              Accueil</router-link>
          </li>
        </ul>
