<template>
  <div class="shadow-xl">
    <TransitionRoot as="template" :show="isDrawerOpen">
      <Dialog as="div" class="fixed inset-0 z-40 flex md:hidden" @close="toggleDrawer(false)">
        ...
        <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
          ...
          <div class="relative flex flex-col flex-1 w-full max-w-xs bg-gray-800">
            <TransitionChild as="template" enter="ease-in-out duration-300" enter-from="opacity-0"
              ...
              <div class="absolute top-0 right-0 pt-2 -mr-12">
                <button type="button"
                  ...
                  <XIconOutline class="w-6 h-6 text-white" aria-hidden="true" />
                </button>
              </div>
            </TransitionChild>
            <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div class="flex items-center flex-shrink-0 px-4">
                <router-link :to="{ name: 'home' }" class="flex items-center justify-center w-full cursor-pointer">
            ...
            <div v-if="userStore.getCurrent" class="flex flex-shrink-0 p-4 bg-gray-700">
    ...
    <div class="flex flex-col flex-1 md:pl-64">
      <div class="sticky top-0 z-10 pt-1 pl-1 bg-gray-100 md:hidden sm:pl-3 sm:pt-3">
        <button type="button"
          ...
          <MenuIconOutline class="w-6 h-6" aria-hidden="true" />
        </button>
      </div>
    </div>
  </div>
